          ...
          <div className="flex-shrink-0 flex items-center">
            <Link href="/">
              <Image 
                ...
                width={180} 
                height={60}
                className="brightness-0 invert p-1" // Deixa a logo clara para contrastar com o marrom
              />
            </Link>
          </div>
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-10">
            <div className="relative w-full">
              <input 
                ...
                className="w-full pl-5 pr-12 py-3 rounded-full bg-white/5 border border-white/10 text-white placeholder:text-white/50 text-sm focus:border-brand-gold focus:ring-1 focus:ring-brand-gold"
              />
